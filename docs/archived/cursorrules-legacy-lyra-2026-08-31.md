...
🚨 NEVER RUN GIT PUSH UNLESS USER SAYS EXACTLY: "push to GitHub". (Not case sensative. "push to github" is also fine.)

After ANY coding task, you MUST:
1. ✅ Commit changes locally
2. ✅ Run linter checks (if applicable)
3. ✅ Say EXACTLY: "✅ Complete. Changes committed locally. Say 'push to GitHub' to push."
4. 🛑 STOP. WAIT. DO NOT PUSH TO GITHUB.

If user says "commit and push" or similar WITHOUT the exact phrase "push to GitHub":
