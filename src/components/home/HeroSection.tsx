...
export function HeroSection() {
  ...
  return (
    <div className="relative text-white overflow-visible min-h-screen flex items-start w-full max-w-full" style={{ minHeight: '100dvh' }}>
        {/* Background Image */}
      ...
      {/* Hero Content */}
      <div className="relative z-50 pt-[15vh] sm:pt-[18vh] md:pt-[20vh] pb-6 sm:pb-12 md:pb-16 lg:pb-20 w-full">
