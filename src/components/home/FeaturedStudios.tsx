...
export function FeaturedStudios({ studios, session }: FeaturedStudiosProps) {
  ...
  return (
    <div id="featured-studios" ref={sectionRef} className="relative z-[10] py-6 sm:py-8 overflow-hidden w-full max-w-full">
      {/* Background Image */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          {placeholders.map((_, index) => (
            ...
            >
              ...
              <div className="aspect-[25/12] bg-gradient-to-br from-gray-100 to-gray-200 rounded-t-lg overflow-hidden relative">
                <Image
                  src="/images/Featured-Studio-Placeholder.png"
                  alt="Add Your Studio"
                  fill
                  className="object-cover"
                />
