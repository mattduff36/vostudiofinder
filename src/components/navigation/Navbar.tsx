...
export function Navbar({ session }: NavbarProps) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 w-full max-w-full [.admin-modal-open_&]:hidden [.image-modal-open_&]:md:block [.image-modal-open_&]:hidden ${
