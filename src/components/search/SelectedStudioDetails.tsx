    ...
    <div className="mt-4">
      ...
      {profileHref ? (
        <Link
          ...
          prefetch={false}
          className={`bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col w-full cursor-pointer ${!hasAnimated ? 'animate-expand-center' : ''}`}
        ...
        <div
          className={`bg-white rounded-lg shadow-lg transition-shadow duration-300 flex flex-col w-full ${!hasAnimated ? 'animate-expand-center' : ''}`}
          style={{ border: '3px solid #EF4444' }}
        >
          {cardContent}
        </div>
