...
import { AlertTriangle, Calendar, Home, Mail } from 'lucide-react';
import { logger } from '@/lib/logger';

export function AccountDeletionScheduledPageClient() {
      ...
      <div className="max-w-lg w-full">
        <div className="bg-white rounded-lg shadow-xl border border-red-200 overflow-hidden">
          <div className="bg-red-50 border-b border-red-200 p-6">
            ...
            <p className="text-center text-sm text-red-700">Your account closure has been initiated</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-red-600 mt-1">•</span>
                  <span>You have been logged out of all devices</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-red-600 mt-1">•</span>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    We have sent a confirmation email with details about your account deletion. It includes instructions on how to cancel if you change your mind.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 space-y-3">
              <Link
                href="/auth/signin"
                className="w-full px-4 py-2 text-sm font-medium text-white bg-[#9C060B] rounded-md hover:bg-[#680407] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#9C060B] transition-colors inline-flex items-center justify-center"
              >
              ...
              <Link
                href="/"
                className="w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors inline-flex items-center justify-center space-x-2"
              >
