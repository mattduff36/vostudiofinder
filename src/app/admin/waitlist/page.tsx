          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="bg-white rounded-lg shadow p-3 md:p-6">
              <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                <div className="w-9 h-9 md:w-12 md:h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-xl md:text-3xl font-bold text-gray-900">{waitlistEntries.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-3 md:p-6">
              <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                <div className="w-9 h-9 md:w-12 md:h-12 bg-yellow-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-xl md:text-3xl font-bold text-gray-900">{featuredCount}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-3 md:p-6">
              <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                <div className="w-9 h-9 md:w-12 md:h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-xl md:text-3xl font-bold text-gray-900">{generalCount}</p>
                </div>
              </div>
            </div>
          </div>
