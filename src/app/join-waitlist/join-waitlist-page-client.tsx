...
import { ArrowRight, Building, Check, Shield, Star, Users } from 'lucide-react';
import { colors } from '@/components/home/HomePage';
import { Footer } from '@/components/home/Footer';

export function JoinWaitlistPageClient() {
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Keep 100% of what you earn. No stupid monthly payments! List your studio for free, or upgrade to Premium for just £30/year to unlock all features.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: `${colors.primary}20` }}>
