...
export const studioSearchSchema = z.object({
  ...
  ids: z.array(z.string()).optional(), // For fetching multiple studios by IDs (map area filtering)
  page: z.number().min(1).default(1),
  limit: z.number().min(1).max(1000).default(18), // Increased max to 1000 for map area filtering
