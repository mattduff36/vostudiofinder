...
export const EMAIL_TEMPLATES: TemplateDefinition[] = [
  ...
  {
    key: 'downgrade-confirmation',
    name: 'Downgrade Confirmation',
    description: 'Sent when a Premium membership expires and the listing moves to Basic plan',
    layout: 'STANDARD',
    isMarketing: false,
    isSystem: true,
    subject: 'Your listing is now on the Basic plan',
    heading: 'Your listing is now on the Basic plan',
    bodyParagraphs: [
      'Hi {{displayName}},',
      ...
      'You can upgrade again at any time for £25/year.',
      'If you have any questions, just reply — we\'re here to help.',
    ],
    ctaPrimaryLabel: 'Upgrade to Premium',
  ...
  {
    key: 'renewal-reminder-30',
    name: 'Premium Renewal Reminder - 30 Days',
    description: 'Sent 30 days before Premium membership expires (transactional, cannot opt out)',
    layout: 'STANDARD',
    isMarketing: false,
    isSystem: true,
    subject: 'Your Premium listing expires in 30 days',
    heading: 'Your Premium listing expires in 30 days',
    bodyParagraphs: [
      'Hi {{displayName}},',
      ...
      '• Phone & directions visibility',
      '• Custom SEO meta title',
      '• Featured studio eligibility',
      '• Additional images and social links',
      'Premium is just £25 per year — often covered by a single booking.',
      'We\'d love to keep your studio fully visible.',
    ],
    ctaPrimaryLabel: 'Renew now',
    ctaPrimaryUrl: '{{renewUrl}}',
    variableSchema: {
      displayName: 'string',
      expiryDate: 'date',
  ...
  {
    key: 'renewal-reminder-14',
    name: 'Premium Renewal Reminder - 14 Days',
    description: 'Sent 14 days before Premium membership expires (transactional, cannot opt out)',
    layout: 'STANDARD',
    isMarketing: false,
    isSystem: true,
    subject: 'Your Premium listing expires in 14 days',
    heading: 'Your Premium listing expires in 14 days',
    bodyParagraphs: [
      'Hi {{displayName}},',
      'Your Premium membership on Voiceover Studio Finder expires on {{expiryDate}}.',
      'If you choose not to renew, your listing will move to our Basic plan and you will lose:',
      '• Voiceover artist listing',
      '• Verified badge',
      '• Phone & directions visibility',
      '• Custom SEO meta title',
  ...
  {
    key: 'renewal-reminder-7',
    name: 'Premium Renewal Reminder - 7 Days',
    description: 'Sent 7 days before Premium membership expires (transactional, cannot opt out)',
    layout: 'STANDARD',
    isMarketing: false,
    isSystem: true,
    subject: 'Your Premium listing expires in 7 days',
    heading: 'Your Premium listing expires in 7 days',
    bodyParagraphs: [
      'Hi {{displayName}},',
      'Your Premium membership on Voiceover Studio Finder expires on {{expiryDate}}.',
      ...
      '• Voiceover category',
      '• Phone & directions visibility',
      '• All images & social links',
      '• Custom Google meta title',
      'It\'s just £25 per year.',
    ],
    ctaPrimaryLabel: 'Renew now',
    ctaPrimaryUrl: '{{renewUrl}}',
    variableSchema: {
  ...
  {
    key: 'renewal-reminder-1',
    name: 'Premium Renewal Reminder - 1 Day',
    description: 'Sent 1 day before Premium membership expires (transactional, cannot opt out)',
    layout: 'STANDARD',
    isMarketing: false,
    isSystem: true,
    subject: 'Your Premium listing expires tomorrow',
    heading: 'Your Premium listing expires tomorrow',
    bodyParagraphs: [
      'Hi {{displayName}},',
      'Your Premium membership expires tomorrow.',
      'Once expired, your listing will automatically move to the Basic plan and some visibility features will be removed.',
      'Renew now to keep your:',
      '• Verified badge',
      '• Voiceover category',
      '• Phone & directions visibility',
