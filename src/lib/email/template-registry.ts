...
export const EMAIL_TEMPLATES: TemplateDefinition[] = [
  ...
  
  {
    ...
    bodyParagraphs: [
      'We\'ve successfully processed your payment. Your membership is now active.',
  ...
  // ============================================
  {
    ...
    description: 'Re-engagement email for users from the old platform (6 months free)',
    layout: 'HERO',
    isMarketing: true,
    isSystem: false,
    ...
    heroImageHeight: 300,
    subject: 'Voiceover Studio Finder is back!',
    preheader: 'We\'ve rebuilt the platform. Six months of free membership is waiting for you.',
    ...
    bodyParagraphs: [
      ...
      'Click the button below to set your password and sign in instantly.',
      'If the button doesn\'t work, copy and paste this link:\n{{resetPasswordUrl}}',
