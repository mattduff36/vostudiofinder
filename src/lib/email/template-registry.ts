...
export const EMAIL_TEMPLATES: TemplateDefinition[] = [
  ...
  
  {
    ...
    bodyParagraphs: [
      ...
      'You can upgrade again at any time for £30/year.',
  ...
  
  {
    ...
    bodyParagraphs: [
      ...
      'Premium is just £30 per year — often covered by a single booking.',
