        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 4px; overflow: hidden;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding: 0;">
                    ...
                    <!-- Text Fallback (hidden when images load, shown when images are blocked) -->
                    <!--[if !mso]><!-->
                    ...
                    <!--<![endif]-->
                    <!-- Outlook Text Fallback (shown in Outlook when images are blocked) -->
                    <!--[if mso]>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #1a1a1a;">
                      <tr>
                        <td align="center" style="padding: 60px 40px 50px 40px;">
          ...
          <tr>
            <td style="padding: 40px 40px 32px 40px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 16px; color: #4a4a4a; line-height: 1.6;">You've been part of our community from the beginning. That's why six months of free membership starts the moment you sign in and see your new profile.</p>
