          ...
          <tr>
            <td style="padding: 0 40px 32px 40px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="left">
                    <a href="https://voiceoverstudiofinder.com/dashboard" style="display: inline-block; padding: 12px 24px; background-color: #d42027; color: #ffffff; text-decoration: none; border-radius: 4px; font-size: 16px; font-weight: 500;">View dashboard</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 0 40px 32px 40px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="left">
                    <a href="https://voiceoverstudiofinder.com/billing" style="display: inline-block; padding: 12px 24px; background-color: #d42027; color: #ffffff; text-decoration: none; border-radius: 4px; font-size: 16px; font-weight: 500;">Update payment method</a>
                  </td>
                </tr>
              </table>
            </td>
